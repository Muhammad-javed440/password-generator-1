...
export default function GeneratePasswordComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-yellow-200 dark:bg-gray-900">
      
      <Card className="w-full max-w-md p-6 bg-yellow-100 dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="mx-auto max-w-md space-y-6">
          
          <div className="space-y-2 text-center">
            <h1 className="text-[40px] font-bold">Password Generator</h1>
